...
const OrderDrink = () =>{
    ...
    return(
        ...
        <div>
                ...
                let { from: { pathname: "/drink" } };
                <Badge color="secondary" badgeContent=" X " onClick={}>
                    <CardImg top width="100%" src={(require("./..\\img\\baitei.png"))} style={{border:"2px solid black",marginLeft:200, width: 450, height: 250,marginTop: }} />
                    </Badge>
                    <CardBody>
                    </CardBody>
